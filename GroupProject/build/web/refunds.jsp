...
<head>
    <meta charset="UTF-8">
    <title>Refunds - Return & Refund System</title>
    <style>
        body {
            margin: 0;
            font-family: 'Segoe UI', Arial, sans-serif;
            background: url('img/background refund.jpg') no-repeat center center fixed;
...
<body>
    ...
    <div class="main-content">
        ...
        <!-- Section: Register New Refund -->
        <div class="section">
            <h3>Register New Refund</h3>
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= refund.getRequestId() %></td>
                            <td><%= refund.getOrderId() %></td>
                            <td><%= refund.getUsername() %></td>
                    ...
                    %>
                        <tr><td colspan="7" style="text-align:center;">No refunds found.</td></tr>
                    <% } %>
                </tbody>
            </table>
        </div>
